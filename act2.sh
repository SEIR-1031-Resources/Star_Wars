...
echo "Help me, Obi-Wan…You’re my only hope." > ./star_wars/rebellion/princess.leia.txt
...
touch ./star_wars/rebellion/han_solo.txt ./star_wars/rebellion/chewbacca.txt
