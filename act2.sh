...
cd star_wars/rebellion && echo "Help me, Obi-Wan…You’re my only hope." >> princes_leia.txt
...
cd star_wars/rebellion/millenium_falcon && touch han_solo.txt chewbacca.txt    
