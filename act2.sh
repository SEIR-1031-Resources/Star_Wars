...
Unsure how to move multiple files at once. Ended up moving them individually. I used mv example.txt millenium_falcon for both obi_wan & luke_skywalker. For princess_leia I was having difficulties and it kept renaming the file to millenium_falcon. I ended up using mv princess_leia ~/millenium_falcon.
