...
cd ~/star_wars/rebellion/millenium_falcon && rm -rf millenium_falcon/
...
cd ~/star_wars/rebellion/millenium_falcon
mv *.txt ~/star_wars/rebellion/death_star
# 2. darth_vader has defeated obi_wan! Delete poor obi_wan.
cd ~/star_wars/rebellion/death_star && rm obi_wan.txt
...
mv ~/star_wars/empire/death_star/darth_vader ~/star_wars/empire/death_star/millenium_falcon
mv ~/star_wars/empire/emperor_palpatine ~/star_wars/empire/death_star/millenium_falcon 
...
mv ~/star_wars/empire/death_star/millenium_falcon ~/star_wars/empire
