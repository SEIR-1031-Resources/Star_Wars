...
mv *txt* ~/sei1031/deliverables/Star_Wars/empire/death_star
...
mv millenium_falcon ~/sei1031/deliverables/Star_Wars/rebellion
# 5. darth_vader leaves the death_star to pursue luke_skywalker! Move him from the death_star into the empire directory!
mv darth_vader.txt ~/sei1031/deliverables/Star_Wars/empire
