...
empire git:(master) ✗ mv death_star/millenium_falcon/*.txt death_star 
...
death_star git:(master) ✗ mv *.txt millenium_falcon
star_wars git:(master) ✗ mv empire/death_star/millenium_falcon/darth_vader.txt empire/death_star 
...
star_wars git:(master) ✗ rm -rf empire/death_star