...
mv empire/death_star/chewbacca.txt empire/death_star/han_solo.txt empire/death_star/luke_skywalker.txt empire/death_star/princess_leia.txt empire/emperor_palpatine.txt empire/death_star/millenium_falcon/
# 4. Move the millenium_falcon back into the rebellion directory.
mv empire/death_star/millenium_falcon/ rebelion/
