# 1. Unload the Millenium Falcon in ONE COMMAND! $ mv millenium_falcom/* ~/star_wars/empire/death_star 
...
$ mv millenium_falcom/* ~/star_wars/empire/death_star 
...
$ mv luke_skywalker.txt princess_leia.txt millenium_falcom 
# 4. Move the millenium_falcon back into the rebellion directory.
$ mv millenium_falcom/ ~/star_wars/rebellion 
